  ...
  return (
    <section>
      ...
      <div className="md:w-3/5 flex flex-col justify-left text-white my-24 mx-16 md:mx-auto">
        ...
        <p className="pb-4">
          In ancient times, there existed a legendary assembly known as "The Council of Six", 
        ...
        <p className="pb-4">As the fabric of reality begins to shift, awakening ancient powers long dormant. 
